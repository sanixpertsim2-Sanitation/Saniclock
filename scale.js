...
header{background:rgba(255,255,255,.86);backdrop-filter:saturate(180%) blur(8px);-webkit-backdrop-filter:saturate(180%) blur(8px);border-bottom:1px solid var(--border)}
...
<style>
:root{
  --bg:#f7f7f5; --surface:#ffffff; --hover:#f1f5f9;
  --ink:#090a0b; --ink2:#475569; --ink3:#94a3b8;
  --line:#e2e8f0; --line2:#d3dae4;
  --brand:#0044ff; --brand-hover:#0033cc; --brand-soft:#ebf1ff;
  --day:#d97706; --aft:#dc2626; --night:#0044ff;
...
body{font-family:var(--sans);background:var(--bg);color:var(--ink);display:flex;-webkit-font-smoothing:antialiased;overflow:hidden}
::selection{background:var(--brand);color:#fff}
@media (max-width:940px){body{flex-direction:column;overflow:auto}}

/* ---------------- LEFT: form ---------------- */
.left{flex:0 0 46%;max-width:560px;background:var(--surface);border-right:1px solid var(--line);display:flex;flex-direction:column;padding:52px 60px}
@media (max-width:940px){.left{flex:none;max-width:none;border-right:0;border-bottom:1px solid var(--line);padding:36px 26px}}
.brandbar{display:flex;align-items:center;gap:14px}
.brandbar img{width:48px;height:48px;border-radius:12px;border:1px solid var(--line);object-fit:contain;background:#fff}
.brandbar b{display:block;font-family:var(--disp);font-size:22px;font-weight:800;letter-spacing:-.02em;line-height:1}
.brandbar span{display:block;margin-top:4px;font-size:10.5px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:var(--brand)}
.formwrap{margin:auto 0;max-width:380px;width:100%}
.eyebrow{font-size:11px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;color:var(--ink3);margin-bottom:14px}
h1{font-family:var(--disp);font-size:44px;font-weight:800;letter-spacing:-.03em;line-height:1;margin-bottom:12px}
.lead{font-size:15px;color:var(--ink2);line-height:1.55;margin-bottom:34px}
...
.inp:focus-within svg{color:var(--brand)}
.inp input{width:100%;height:52px;background:var(--surface);border:1px solid var(--line);border-radius:10px;color:var(--ink);font-family:var(--sans);font-size:15px;padding:0 14px 0 44px;outline:none;transition:border-color .2s,box-shadow .2s}
.inp input::placeholder{color:#aeb8c6}
.inp input:focus{border-color:var(--brand);box-shadow:0 0 0 4px rgba(0,68,255,.12)}
.btn{width:100%;height:52px;margin-top:22px;border:0;border-radius:10px;cursor:pointer;font-family:var(--sans);font-size:15px;font-weight:700;color:#fff;background:var(--brand);transition:transform .18s ease,background .18s ease,box-shadow .18s ease;display:flex;align-items:center;justify-content:center;gap:9px}
.btn:hover{background:var(--brand-hover);transform:translateY(-2px);box-shadow:0 10px 28px -12px rgba(0,68,255,.6)}
.btn:active{transform:none}
.btn[disabled]{opacity:.6;cursor:default;transform:none}
.err{background:var(--status-error-bg,#fef2f2);border:1px solid #fecaca;color:#dc2626;font-size:13px;padding:11px 13px;border-radius:9px;margin-bottom:16px;display:none}
.trust{margin-top:26px;display:flex;align-items:center;gap:8px;font-size:12px;color:var(--ink3)}
.trust svg{width:14px;height:14px}
.leftfoot{margin-top:auto;padding-top:34px;font-size:11.5px;color:var(--ink3);letter-spacing:.01em}
...
/* ---------------- RIGHT: clock + shifts ---------------- */
.right{flex:1;min-width:0;position:relative;display:flex;flex-direction:column;justify-content:center;padding:56px 64px;overflow:hidden}
.right::before{content:"";position:absolute;inset:0;pointer-events:none;
  background-image:linear-gradient(var(--line) 1px,transparent 1px),linear-gradient(90deg,var(--line) 1px,transparent 1px);background-size:56px 56px;opacity:.5;
  mask-image:radial-gradient(ellipse 80% 70% at 40% 45%,#000,transparent 88%);-webkit-mask-image:radial-gradient(ellipse 80% 70% at 40% 45%,#000,transparent 88%)}
.right::after{content:"";position:absolute;top:-10%;right:-6%;width:520px;height:520px;pointer-events:none;background:radial-gradient(circle,rgba(0,68,255,.06),transparent 62%)}
@media (max-width:940px){.right{padding:34px 26px 46px}}
.right>*{position:relative;z-index:2}
.clocklabel{font-size:11px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:var(--ink3);display:flex;align-items:center;gap:10px;margin-bottom:16px;opacity:0;animation:up .6s .05s cubic-bezier(.23,1,.32,1) forwards}
.clocklabel .live{width:7px;height:7px;border-radius:50%;background:#059669;position:relative}
.clocklabel .live::after{content:"";position:absolute;inset:-4px;border-radius:50%;border:1px solid #059669;opacity:.5;animation:ping 2s ease-out infinite}
@keyframes ping{0%{transform:scale(.6);opacity:.6}100%{transform:scale(1.8);opacity:0}}
.clock{font-family:var(--disp);font-size:clamp(80px,11vw,168px);font-weight:800;letter-spacing:-.05em;line-height:.86;color:var(--ink);font-variant-numeric:tabular-nums;opacity:0;animation:up .7s .12s cubic-bezier(.23,1,.32,1) forwards}
.clock .sec{font-family:var(--mono);font-weight:500;color:var(--brand);font-size:.26em;letter-spacing:0;vertical-align:.9em;margin-left:.12em}
.date{margin-top:16px;font-size:15px;color:var(--ink2);font-weight:500;opacity:0;animation:up .6s .2s cubic-bezier(.23,1,.32,1) forwards}
@keyframes up{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:none}}

.shiftlabel{margin-top:52px;font-size:11px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:var(--ink3);display:flex;align-items:center;gap:14px;opacity:0;animation:up .6s .28s cubic-bezier(.23,1,.32,1) forwards}
.shiftlabel .ln{flex:1;height:1px;background:var(--line)}
.shifts{margin-top:16px;display:grid;grid-template-columns:repeat(3,1fr);gap:14px;max-width:620px}
@media (max-width:520px){.shifts{grid-template-columns:1fr}}
.shift{position:relative;background:var(--surface);border:1px solid var(--line);border-top:3px solid var(--line);border-radius:0 0 10px 10px;padding:16px 16px 15px;opacity:0;transform:translateY(12px);animation:up .6s cubic-bezier(.23,1,.32,1) forwards;transition:border-color .3s,box-shadow .3s,transform .3s}
.shift:nth-child(1){animation-delay:.34s}.shift:nth-child(2){animation-delay:.4s}.shift:nth-child(3){animation-delay:.46s}
.shift .sh-top{display:flex;align-items:center;justify-content:space-between}
.shift .sh-name{font-family:var(--disp);font-size:18px;font-weight:800;letter-spacing:-.02em;color:var(--ink3);transition:color .3s}
.shift .sh-badge{font-size:9px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#fff;background:var(--brand);padding:3px 8px;border-radius:999px;opacity:0;transition:opacity .3s}
.shift .sh-time{margin-top:7px;font-family:var(--mono);font-size:12.5px;color:var(--ink3);letter-spacing:-.02em;transition:color .3s}
.shift .sh-bar{position:relative;margin-top:14px;height:4px;border-radius:999px;background:var(--hover);overflow:hidden}
.shift .sh-fill{position:absolute;left:0;top:0;bottom:0;width:0;border-radius:999px;background:var(--brand);transition:width 1s cubic-bezier(.23,1,.32,1)}
.shift .sh-meta{margin-top:9px;font-size:10.5px;color:var(--ink3);font-weight:600;letter-spacing:.01em;font-variant-numeric:tabular-nums}
.shift.now{border-color:var(--brand);border-top-color:var(--brand);box-shadow:0 6px 26px -14px rgba(0,68,255,.5);transform:translateY(-3px)}
.shift.now .sh-name,.shift.now .sh-time{color:var(--ink)}
.shift.now .sh-badge{opacity:1}
.shift.now .sh-meta{color:var(--brand)}
.rightfoot{margin-top:52px;font-size:11.5px;color:var(--ink3);display:flex;justify-content:space-between;gap:12px;opacity:0;animation:up .6s .6s cubic-bezier(.23,1,.32,1) forwards}
.rightfoot b{color:var(--ink2);font-weight:700}
@media (prefers-reduced-motion:reduce){*{animation:none!important}[class]{opacity:1!important;transform:none!important}}
</style></head>
<body>
<section class="left">
...
<section class="right">
  ...
  <div class="shiftlabel">Shift coverage · 24 / 7 <span class="ln"></span></div>
  <div class="shifts" id="shifts">
    <div class="shift" data-s="day"><div class="sh-top"><span class="sh-name">Day</span><span class="sh-badge">On now</span></div><div class="sh-time">07:00 – 15:00</div><div class="sh-bar"><span class="sh-fill"></span></div><div class="sh-meta" data-meta>8-hour shift</div></div>
    <div class="shift" data-s="aft"><div class="sh-top"><span class="sh-name">Afternoon</span><span class="sh-badge">On now</span></div><div class="sh-time">15:00 – 23:00</div><div class="sh-bar"><span class="sh-fill"></span></div><div class="sh-meta" data-meta>8-hour shift</div></div>
    <div class="shift" data-s="night"><div class="sh-top"><span class="sh-name">Night</span><span class="sh-badge">On now</span></div><div class="sh-time">23:00 – 07:00</div><div class="sh-bar"><span class="sh-fill"></span></div><div class="sh-meta" data-meta>8-hour shift</div></div>
  </div>
