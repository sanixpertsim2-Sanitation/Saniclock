...
<div class="appShell">
  <aside class="sidebar" id="sidebar">
    ...
    <div class="navGroup">
      ...
      <button class="navItem soon" id="navAbsence" type="button" aria-disabled="true" title="Coming soon">
        ...
        <span class="navLabel">Request Absence</span>
        <span class="navSoon">Soon</span>
      </button>
    </div>
...
var VIEWS=["dashboard","mend","viewpunch","timecard","report","groups","devices","settings"];
var VIEW_EL={dashboard:"dashboardView",mend:"mendView",viewpunch:"viewPunchView",timecard:"timecardView",report:"reportView",groups:"groupsView",devices:"devicesView",settings:"settingsView"};
var VIEW_NAV={dashboard:"navDashboard",mend:"navMend",viewpunch:"navViewPunch",timecard:"navTimecard",report:"navReport",groups:"navGroups",devices:"navDevices",settings:"navSettings"};
function setView(v){
  state.view=v;
...
.ribbon{margin-top:38px;display:flex;flex-direction:column;gap:11px;max-width:460px}
.srow{display:flex;align-items:center;gap:15px;padding:14px 18px;border-radius:15px;border:1px solid var(--line);
  background:rgba(255,255,255,.012);transition:border-color .4s,background .4s,transform .4s,box-shadow .4s;opacity:0;transform:translateX(-14px);animation:slidein .7s cubic-bezier(.16,1,.3,1) forwards}
.srow:nth-child(1){animation-delay:.5s}.srow:nth-child(2){animation-delay:.58s}.srow:nth-child(3){animation-delay:.66s}
@keyframes slidein{to{opacity:1;transform:none}}
.srow.now{border-color:var(--line2);background:linear-gradient(100deg,rgba(47,123,255,.12),rgba(47,123,255,.03));box-shadow:0 0 0 1px rgba(47,123,255,.15),0 16px 40px -18px var(--glow);transform:translateX(4px)}
.srow .dot{width:10px;height:10px;border-radius:50%;flex:none;box-shadow:0 0 12px currentColor}
.srow.day .dot{background:var(--c-day);color:var(--c-day)}.srow.aft .dot{background:var(--c-aft);color:var(--c-aft)}.srow.night .dot{background:var(--c-night);color:var(--c-night)}
.srow .nm{font-size:15px;font-weight:600;letter-spacing:.01em}
.srow .rg{font-size:13px;color:var(--ink3);font-variant-numeric:tabular-nums;font-weight:400}
.srow .now-pill{margin-left:auto;font-size:9.5px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;color:var(--brand3);border:1px solid var(--line2);padding:4px 11px;border-radius:999px;opacity:0;transition:opacity .4s}
.srow.now .now-pill{opacity:1}
.srow:not(.now) .rg{margin-left:auto}
...
@media (max-width:900px){
  ...
  .ribbon{margin-top:24px}.stagefoot{margin-top:26px}
...
@media (prefers-reduced-motion:reduce){*{animation:none!important}.srow,.card,.brandbar,.statement,.eyebrow,.clock,.date,.stagefoot{opacity:1!important;transform:none!important}}
</style></head>
<body>
<section class="stage">
  <div class="aurora"><i></i><i></i><i></i></div>
  <div class="brandbar">
    <img class="mark" src="/brand-badge.png" alt="SaniXperts"/>
    <div class="wm"><b>SaniClock</b><span>by SaniXperts</span></div>
  </div>
  <div class="statement"><h2>Every shift, in <em>sharp focus</em>.</h2><p>Live attendance and automatic payroll for the entire Ferrero floor — engineered into one effortless workspace.</p></div>
  <div class="hero">
    ...
    <div class="ribbon" id="ribbon">
      <div class="srow day" data-s="day"><span class="dot"></span><span class="nm">Day</span><span class="rg">07:00 – 15:00</span><span class="now-pill">On now</span></div>
      <div class="srow aft" data-s="aft"><span class="dot"></span><span class="nm">Afternoon</span><span class="rg">15:00 – 23:00</span><span class="now-pill">On now</span></div>
      <div class="srow night" data-s="night"><span class="dot"></span><span class="nm">Night</span><span class="rg">23:00 – 07:00</span><span class="now-pill">On now</span></div>
    </div>
  </div>
...
function tick(){
  ...
  Array.prototype.forEach.call(document.querySelectorAll(".srow"),function(r){r.classList.toggle("now",r.getAttribute("data-s")===cur)});
}
