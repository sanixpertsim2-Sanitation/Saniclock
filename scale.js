...
const server = http.createServer((req, res) => {
  ...
  const PUBLIC_ROUTES = new Set(['/login', '/api/login', '/api/logout', '/favicon.ico', '/manifest.webmanifest', '/sw.js', '/icon.svg', '/icon-180.png', '/icon-192.png', '/icon-512.png', '/icon-maskable-512.png', '/login-bg.jpg', '/stage-bg.jpg', '/brand-badge.png', '/brand-flame.png', '/brand-white.png', '/brand-mark.png', '/api/emp-login', '/api/emp-logout', '/api/my-punches', '/api/my-absence-requests', '/api/emp-change-password', '/me', '/manifest-me.webmanifest']);
  ...
  if (url === '/login-bg.jpg' || url === '/stage-bg.jpg') {
    try { const buf = fs.readFileSync(path.join(__dirname, 'data', url.slice(1))); res.writeHead(200, { 'Content-Type': 'image/jpeg', 'Cache-Control': 'public, max-age=604800' }); res.end(buf); }
