...
.top img{height:34px;width:auto;object-fit:contain;filter:drop-shadow(0 2px 10px var(--glow))}
...
.brandbar{display:flex;align-items:center;gap:15px;opacity:0;animation:up .7s .04s cubic-bezier(.22,1,.32,1) forwards}
.brandbar img{height:52px;width:auto;object-fit:contain;filter:drop-shadow(0 4px 16px rgba(79,140,255,.55))}
.brandbar b{display:block;font-family:var(--disp);font-size:25px;font-weight:800;letter-spacing:-.025em;line-height:1;background:linear-gradient(180deg,#ffffff,#c3d6f5);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}
...
<body>
<section class="left">
  <div class="brandbar"><img src="/brand-mark.png" alt="SaniXperts"/><div><b>SaniClock</b><span>Powered by SaniXperts</span></div></div>
  <div class="formwrap">
...
const server = http.createServer((req, res) => {
  ...
  const PUBLIC_ROUTES = new Set(['/login', '/api/login', '/api/logout', '/favicon.ico', '/manifest.webmanifest', '/sw.js', '/icon.svg', '/icon-180.png', '/icon-192.png', '/icon-512.png', '/icon-maskable-512.png', '/login-bg.jpg', '/brand-badge.png', '/brand-flame.png', '/brand-white.png', '/brand-mark.png', '/api/emp-login', '/api/emp-logout', '/api/my-punches', '/api/my-absence-requests', '/api/emp-change-password', '/me', '/manifest-me.webmanifest']);
